...
El sistema de numeración decimal o base 10 es el que empleamos en el día a día, y está formado por 10 dígitos, del 0 al 9.
En este sistema cualquier número se puede descomponer usando potencias de 10. 
...
El sistema de numeración binaria o base 2, como hemos visto, es el que emplean los ordenadores, y está formado por dos dígitos: 0 y 1.

Cada número binario se corresponde con un número decimal y viceversa. 
...
## 2.2 Conversión entre el sistema decimal y binario
...
Para convertir un número binario a decimal, se multiplica cada cifra por la potencia de 2 que corresponde a su posición.
